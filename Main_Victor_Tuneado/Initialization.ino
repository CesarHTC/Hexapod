void Initialization_set_1() 
{
  ...
  L = 0;
  //          (   pin   , 0,         angle         )
  pca41.setPWM(Pin[L][0], 0, getPWM(q_offset[L][0]));      // L1_q1
  pca41.setPWM(Pin[L][1], 0, getPWM(q_offset[L][1]));      // L1_q2
  pca41.setPWM(Pin[L][2], 0, getPWM(q_offset[L][2]));      // L1_q3

  // -------------------------------------------

  L = 1;
  //          (   pin   , 0,         angle         )
  pca41.setPWM(Pin[L][0], 0, getPWM(q_offset[L][0]));      // L2_q1
  pca41.setPWM(Pin[L][1], 0, getPWM(q_offset[L][1]));      // L2_q2
  pca41.setPWM(Pin[L][2], 0, getPWM(q_offset[L][2]));      // L2_q3
  ...
  L = 3;
  //          (   pin   , 0,         angle         )
  pca40.setPWM(Pin[L][0], 0, getPWM(q_offset[L][0]));      // L4_q1
  pca40.setPWM(Pin[L][1], 0, getPWM(q_offset[L][1]));      // L4_q2
  pca40.setPWM(Pin[L][2], 0, getPWM(q_offset[L][2]));      // L4_q3
